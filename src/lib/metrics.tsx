...
export function useMetrics(){
 ...
 const stats=useQuery({queryKey:['pi','live-stats',cwd,sessionId],queryFn:()=>request<Stats>({type:'get_session_stats'},30000,cwd),enabled:online,refetchInterval:2000,refetchIntervalInBackground:true})
