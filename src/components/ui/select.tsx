  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon
        render={
          <Icon name="caret-down" className="pointer-events-none size-3.5 text-muted-foreground" />
        }
      />
    </SelectPrimitive.Trigger>
  )
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.ItemIndicator
        render={
          <span data-slot="select-item-indicator" className="pointer-events-none absolute right-2 flex items-center justify-center" />
        }
      >
        <Icon name="check" className="pointer-events-none size-3.5" />
      </SelectPrimitive.ItemIndicator>
    </SelectPrimitive.Item>
  )
}
