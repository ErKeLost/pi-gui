...
export function ExtensionDialog({dialog}:{dialog:UiRequest}){
 ...
 async function answer(data:{value?:string;confirmed?:boolean;cancelled?:boolean}){setPending(true);try{await answerDialog(dialog,data)}catch(e){report(e);setPending(false)}}
