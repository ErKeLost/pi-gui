...
const phosphorNames=['code','user','brain','terminal-window','caret-down','copy','folder-open','magnifying-glass','arrow-up-right','arrow-down','arrow-down-right','arrow-left','paperclip','command','x','stop-fill','arrow-up','plus','chats','git-commit','arrow-bend-up-right','bookmark-simple','git-fork','tree-structure','sparkle','puzzle-piece','text-align-left','arrow-right','caret-right','chat-circle-dots','chat-circle-text','sidebar-simple','folder-simple','caret-up-down','caret-up','dots-three','chat-circle','gear-six','desktop','device-mobile','export','browser','warning-circle','info','sun','moon','palette','microphone','lightbulb','list','trash','translate','youtube-logo-fill','github-logo','x-logo','figma-logo','discord-logo','slack-logo','linkedin-logo','reddit-logo','file-magnifying-glass','globe','article','chart-bar','video-camera','image-square','film-strip','music-notes','cloud-sun','bug','database','list-checks','calendar-blank','rocket-launch','magic-wand','book-open','robot','users-three','flow-arrow','chat-teardrop-text','cube','note-pencil','stack','compass','package','leaf','arrows-clockwise','check','download','funnel','keyboard','pencil-simple','plugs-connected','share-network','buildings','cpu','key','link','list-magnifying-glass','identification-card','floppy-disk','play-circle','shield-check','wrench','sliders-horizontal','plus-circle','dots-three-bold']
